...
export default function OgNote({
  ...
  return (
    ...
    >
      ...
      >
        {/* 3a. Eyebrow comment-tag "// note" — accent moment #1 */}
        <span
          style={{
            fontFamily: '\'JetBrains Mono\', monospace',
            fontSize: '17px',
        ...
        >
          <span style={{ color: '#9DAA95' }}>{date}</span>
        </div>
      </div>
    </div>
  );
