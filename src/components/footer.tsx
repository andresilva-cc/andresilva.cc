            ...
            <li key={item.url}>
              <Text asChild variant="micro">
                <a
                  ...
                  className="lowercase font-normal text-fg-subtle no-underline motion-safe:transition-colors motion-safe:duration-fast motion-safe:ease-out motion-safe:hover:text-accent motion-safe:hover:underline"
                >
                  { item.title }
                </a>
              </Text>
